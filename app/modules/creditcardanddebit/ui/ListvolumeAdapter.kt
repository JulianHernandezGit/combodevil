...
import com.combodeals.app.databinding.RowListvolumeBinding
...
class ListvolumeAdapter(
  ...
  inner class RowListvolumeVH(
    ...
    init {
      binding.linearCreditcard.setOnClickListener {
        // TODO replace with value from datasource
        clickListener?.onItemClick(it, adapterPosition, ListvolumeRowModel())
      }
    }
  }
}
